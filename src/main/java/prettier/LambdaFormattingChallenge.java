...
public class LambdaFormattingChallenge {
  ...
  public static void main(String[] args) {
    ...
    Function<Integer, Integer> doubleAndSquare = num -> {
      int doubled = num * 2;
    ...
    Function<String, Function<String, String>> concatFunction = str1 ->
      str2 -> str1 + " " + str2 + " adding something that is very logn for no reason";
