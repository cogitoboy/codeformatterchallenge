...
public class GenericsFormattingChallenge<T extends Comparable<T>> {
  ...
  public static <E extends Comparable<E>> List<E> sortItems(List<E> list) {
    List<E> sortedList = new ArrayList<>(
      list
    );/*  this is an very important comment, becuse if you delete this line then the world will end in a giant boom! */
  ...
  public String toString() {
    return (
      "GenericsFormattingChallenge{" + "items=" + items + ", itemMap=" + itemMap + '}'
    );
  }

  public static void main(String[] args) {
    GenericsFormattingChallenge<Integer> challenge = new GenericsFormattingChallenge<>(
      1,
      2,
      3
    );
